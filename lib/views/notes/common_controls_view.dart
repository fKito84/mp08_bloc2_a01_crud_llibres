...
class CommonControlsView {
  ...
  String? _validatorTextTitol(String? pValue) {
    return _validatorTextString(ConstantsView.LABEL_LLIBRE_TITOL, pValue, false, 1, 20);
  }

  String? _validatorTextContingut(String? pValue) {
    return _validatorTextString(ConstantsView.LABEL_LLIBRE_CONTINGUT, pValue, false, 1, 100);
  }
